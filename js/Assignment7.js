function MenuChoice(selection)
{
    ...
    document.getElementById("section10").style.position = "absolute";
    document.getElementById("section11").style.visibility = "hidden";
    document.getElementById("section11").style.display = "none";
    document.getElementById("section11").style.position = "absolute";
    ...
    switch(selection)
    {
        ...
        case "About":
            ...
            document.getElementById("section11").style.position = "relative";
            break;
        case "None":
...
function SearchContacts()
{
    ...
    navigator.contacts.find(fields, onPass, onIssue, options);
}

function onPass(contacts)
{
...
//    alert("Battery Level: " + status.level + "%")
    var batstat = "Battery Level: " + status.level + "%";
    document.getElementById("batterystatusdisplay").style.visibility = "visible";
    document.getElementById("batterystatusdisplay").style.display = "block";
    document.getElementById("batterystatusdisplay").innerHTML = batstat;
}